        ...
        >
          ...
          <div className="glassmorphism rounded-2xl p-8 sm:p-10 relative overflow-hidden">
            ...
            <p className="text-base sm:text-lg text-text-secondary leading-relaxed mb-8 max-w-3xl">
              ...
              <span className="text-orange-DEFAULT font-medium">neuro-reactive VR</span>{' '}
              interfaces. I specialize in bridging the gap between the physical layer and the digital
              edge, ensuring that{' '}
